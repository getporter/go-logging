...
func testCallpath(t *testing.T, format string, expect string) {
	...
	if !strings.HasPrefix(parts[1], expect) {
		t.Errorf("incorrect callpath: want, %s got: %s", expect, parts[1])
	}
...
func TestLogCallpath(t *testing.T) {
	testCallpath(t, "%{callpath} %{message}", "TestLogCallpath.String.rec...a.b.c.c")
	testCallpath(t, "%{callpath:-1} %{message}", "TestLogCallpath.String.rec...a.b.c.c")
	testCallpath(t, "%{callpath:0} %{message}", "TestLogCallpath.String.rec...a.b.c.c")
